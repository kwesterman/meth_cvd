...
\DIFaddtex{Mendelian randomization (MR) analyses were undertaken for the 4 DMR CpGs
...
\DIFaddtex{Cell type-module interaction analyses were undertaken using a similar
...
\DIFaddtex{Of CpGs in these 3 identified DMRs, 4 (2 in SLC1A5 and 1 each in SLC9A1
...
cardiovascular risk between the two cohorts examined here. \DIFaddtex{To validate
...
{[}41{]} and DNA methylation in general {[}42{]}. \DIFaddtex{While a two-step
...
differentially methylated regions that \DIFaddtex{show limited evidence for a
...
\DIFaddtex{The Genotype-Tissue Expression (GTEx) Project was supported by the
