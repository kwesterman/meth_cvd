...
# FHS
fhs_c1=/cluster/home/kweste01/kw/ncbi/dbGaP-60162_FHS_gen_IRBMDS/PhenoGenotypeFiles/ChildStudyConsentSet_phs000342.Framingham.v17.p10.c1.HMB-IRB-MDS/GenotypeFiles/phg000679.v1.FHS_SHARe_Imputed_1000G.genotype-imputed-data.c1
fhs_c2=/cluster/home/kweste01/kw/ncbi/dbGaP-60163_FHS_gen_IRBNPUMDS/PhenoGenotypeFiles/ChildStudyConsentSet_phs000342.Framingham.v17.p10.c2.HMB-IRB-NPU-MDS/GenotypeFiles/phg000679.v1.FHS_SHARe_Imputed_1000G.genotype-imputed-data.c2
#for ((i=1; i<=22; i++)); do 
...
#	gcta64 --dosage-mach-gz ${fhs_c1}/machout.chr${i}.dose_GRU.gz ${fhs_c1}/imputed-metrics/machout.chr${i}.info.gz --keep ../int/meth_ids.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/fhs_c1_chr${i}
#	gcta64 --dosage-mach-gz ${fhs_c2}/machout.chr${i}.dose_NPU.gz ${fhs_c2}/imputed-metrics/machout.chr${i}.info.gz --keep ../int/meth_ids.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/fhs_c2_chr${i}
#done
...
#	gcta64 --dosage-mach-gz ${whi_c1_as264}/AS264chr${i}c.dose.c1.gz ../int/plink_imputed/as264-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_as264_chr${i}
#	gcta64 --dosage-mach-gz ${whi_c2_as264}/AS264chr${i}c.dose.c2.gz ../int/plink_imputed/as264-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c2_as264_chr${i}
#done
...
#	gcta64 --dosage-mach-gz ${whi_c1_garnet}/GARNETchr${i}c.dose.c1.gz ../int/plink_imputed/garnet-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_garnet_chr${i}
#	gcta64 --dosage-mach-gz ${whi_c2_garnet}/GARNETchr${i}c.dose.c2.gz ../int/plink_imputed/garnet-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c2_garnet_chr${i}
#done
...
#	gcta64 --dosage-mach-gz ${whi_c1_gecco_cyto}/GECCOchr${i}cyto.dose.c1.gz ../int/plink_imputed/gecco_cyto-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_gecco_cyto_chr${i}
...
#	gcta64 --dosage-mach-gz ${whi_c1_gecco_init}/GECCOchr${i}init.dose.c1.gz ../int/plink_imputed/gecco_init-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_gecco_init_chr${i}
...
#	gcta64 --dosage-mach-gz ${whi_c1_hipfx}/HIPFXchr${i}c.dose.c1.gz ../int/plink_imputed/hipfx-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_hipfx_chr${i}
#	gcta64 --dosage-mach-gz ${whi_c2_hipfx}/HIPFXchr${i}c.dose.c2.gz ../int/plink_imputed/hipfx-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c2_hipfx_chr${i}
#done
...
#	gcta64 --dosage-mach-gz ${whi_c1_whims}/WHIMSchr${i}c.dose.c1.gz ../int/plink_imputed/whims-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_whims_chr${i}
#	gcta64 --dosage-mach-gz ${whi_c2_whims}/WHIMSchr${i}c.dose.c2.gz ../int/plink_imputed/whims-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c2_whims_chr${i}
#done
...
#	gcta64 --dosage-mach-gz ${whi_c1_share_aa}/SHAREchr${i}aa.dose.c1.gz ../int/plink_imputed/share_aa-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_share_aa_chr${i}
#	gcta64 --dosage-mach-gz ${whi_c2_share_aa}/SHAREchr${i}aa.dose.c2.gz ../int/plink_imputed/share_aa-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c2_share_aa_chr${i}
#done
...
#	gcta64 --dosage-mach-gz ${whi_c1_share_ha}/SHAREchr${i}ha.dose.c1.gz ../int/plink_imputed/share_ha-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c1_share_ha_chr${i}
#	gcta64 --dosage-mach-gz ${whi_c2_share_ha}/SHAREchr${i}ha.dose.c2.gz ../int/plink_imputed/share_ha-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.9 --make-bed --out ../int/plink_imputed/whi_c2_share_ha_chr${i}
#done
